package com.example.SchoolLunchReport.analyze.controller;

import com.example.SchoolLunchReport.analyze.dto.*;
import com.example.SchoolLunchReport.analyze.service.AnalyzeService;
import com.example.SchoolLunchReport.analyze.service.DjangoService;
...
public class AnalyzeController {
    ...
    public ResponseEntity<?> getFoodEvaluationSummary(@RequestBody Map<String, Object> request) {
        try {
            ...
            FoodEvaluationRequestDto evaluationData = analyzeService.getFoodEvaluations(foodId, startDate, endDate);
            ...
            FoodEvaluationResponseDto djangoResponse = djangoService.sendEvaluationsToDjango(evaluationData);
