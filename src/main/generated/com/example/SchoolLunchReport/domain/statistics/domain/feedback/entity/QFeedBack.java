...
public class QFeedBack extends EntityPathBase<FeedBack> {
    ...
    private static final long serialVersionUID = -59994629L;
    ...
    public final com.example.SchoolLunchReport.domain.product.FoodMenu.domain.entity.QFoodMenu foodMenu;
    ...
    public QFeedBack(Class<? extends FeedBack> type, PathMetadata metadata, PathInits inits) {
        ...
        this.foodMenu = inits.isInitialized("foodMenu") ? new com.example.SchoolLunchReport.domain.product.FoodMenu.domain.entity.QFoodMenu(forProperty("foodMenu"), inits.get("foodMenu")) : null;
    }
