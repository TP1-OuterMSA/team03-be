...
public class QSuggestion extends EntityPathBase<Suggestion> {
    ...
    private static final long serialVersionUID = 1390246586L;
    ...
    public final EnumPath<com.example.SchoolLunchReport.product.food.domain.type.Category> category = createEnum("category", com.example.SchoolLunchReport.product.food.domain.type.Category.class);
    ...
    public final com.example.SchoolLunchReport.product.food.domain.entity.QFood food;
    ...
    public QSuggestion(Class<? extends Suggestion> type, PathMetadata metadata, PathInits inits) {
        ...
        this.food = inits.isInitialized("food") ? new com.example.SchoolLunchReport.product.food.domain.entity.QFood(forProperty("food")) : null;
    }
